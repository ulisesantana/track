...
<!-- toc -->
* [track - A [Toggl Track](https://track.toggl.com) personal CLI](#track---a-toggl-trackhttpstracktogglcom-personal-cli)
* [Usage](#usage)
* [Commands](#commands)
<!-- tocstop -->
# Usage
...
running command...
$ track (--version)
@ulisesantana/track/1.0.7 darwin-arm64 node-v20.6.0
$ track --help [COMMAND]
USAGE
  $ track COMMAND
...
...
_See code: [src/commands/config.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/config.ts)_
...
_See code: [src/commands/continue.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/continue.ts)_
...
_See code: [src/commands/current.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/current.ts)_
...
_See code: [src/commands/set/description.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/set/description.ts)_
...
_See code: [src/commands/set/project.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/set/project.ts)_
...
_See code: [src/commands/set/token.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/set/token.ts)_
...
_See code: [src/commands/set/workspace.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/set/workspace.ts)_
...
_See code: [src/commands/setup.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/setup.ts)_
...
_See code: [src/commands/start.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/start.ts)_
...
_See code: [src/commands/stop.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/stop.ts)_
...
_See code: [src/commands/today.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/today.ts)_
...
_See code: [src/commands/week.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/week.ts)_
...
_See code: [src/commands/yesterday.ts](https://github.com/ulisesantana/track/blob/v1.0.7/src/commands/yesterday.ts)_
<!-- commandsstop -->
